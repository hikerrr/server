    ...
    <div class="destination-form">
      <form class="form">
        ...
        <div class="form-field">
          ...
          <div class="cities">
            <label v-for='substyle in substyles' :key='substyle._id'>
              <input type="checkbox" name='substyles[]' :value="substyle._id" class='form-checkbox'>
        ...
        <router-link to='/admin/dashboard/styles'>
          <a href="/admin/dashboard/styles" class='form-btn'>Back</a>
        </router-link>
        <div class="loader">
...
export default {
  ...
  methods: {
    saveData(evt) {
      ...
      this.$store.dispatch('addStyle',this.style)
        .then(() => {
          this.loading = false;
          this.msg = 'Updated';
          bus.$emit('loadEnd');
